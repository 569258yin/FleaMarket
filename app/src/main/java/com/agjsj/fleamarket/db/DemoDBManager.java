package com.agjsj.fleamarket.db;
...
import com.agjsj.fleamarket.db.InviteMessage.InviteMesageStatus;
...
public class DemoDBManager {
    ...
    private DemoDBManager(){
        dbHelper = DbOpenHelper.getInstance(BaseApplication.INSTANCE());
    }
    ...
    synchronized public Map<String, EaseUser> getContactList() {
        ...
        if (db.isOpen()) {
            ...
            while (cursor.moveToNext()) {
                ...
                if (username.equals(GlobalParams.NEW_FRIENDS_USERNAME) || username.equals(GlobalParams.GROUP_USERNAME)
                        || username.equals(GlobalParams.CHAT_ROOM)|| username.equals(GlobalParams.CHAT_ROBOT)) {
