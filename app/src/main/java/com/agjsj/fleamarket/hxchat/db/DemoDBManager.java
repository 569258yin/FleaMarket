package com.agjsj.fleamarket.hxchat.db;
...
import com.agjsj.fleamarket.hxchat.Constant;
...
public class DemoDBManager {
    ...
    private DemoDBManager(){
        dbHelper = DbOpenHelper.getInstance(BaseApplication.INSTANCE().getApplicationContext());
    }
