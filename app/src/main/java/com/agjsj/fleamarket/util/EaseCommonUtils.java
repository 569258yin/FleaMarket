...
public class EaseCommonUtils {
	...
	public static EMMessage createExpressionMessage(String toChatUsername, String expressioName, String identityCode) {
		...
		if (identityCode != null) {
			message.setAttribute(GlobalParams.MESSAGE_ATTR_EXPRESSION_ID, identityCode);
		}
		message.setAttribute(GlobalParams.MESSAGE_ATTR_IS_BIG_EXPRESSION, true);
		return message;
	}
	...
	public static String getMessageDigest(EMMessage message, Context context) {
		...
		case TXT: // 文本消息
			...
			} else if (message.getBooleanAttribute(GlobalParams.MESSAGE_ATTR_IS_VIDEO_CALL, false)) {
				digest = getString(context, R.string.video_call) + txtBody.getMessage();
			} else if (message.getBooleanAttribute(GlobalParams.MESSAGE_ATTR_IS_BIG_EXPRESSION, false)) {
	...
	public static EMConversationType getConversationType(int chatType) {
		if (chatType == GlobalParams.CHATTYPE_SINGLE) {
			return EMConversationType.Chat;
		} else if (chatType == GlobalParams.CHATTYPE_GROUP) {
